      ...
      columns: [
        {
          title: 'Actions',
          links: [
            { label: 'New Analysis', path: '/workspace', desc: 'Start a new contract breakdown' },
          ]
        }
      ]
    },
      ...
      columns: [
        {
          title: 'Analytics',
          links: [
            { label: 'Portfolio Overview', path: '/dashboard#portfolio-overview', desc: 'High-level performance metrics and score' },
            { label: 'Category Breakdown', path: '/dashboard#category-breakdown', desc: 'Health, Auto, Home, and Life segments' },
          ]
        },
        {
          title: 'Reports',
          links: [
            { label: 'Critical Risks', path: '/dashboard#critical-risks', desc: 'Top vulnerabilities across all policies' },
            { label: 'Recent Analyses', path: '/policies', desc: 'Quickly access your latest contract data' },
          ]
        }
      ]
    },
      ...
      columns: [
        {
          title: 'Engines',
          links: [
            { label: 'Side-by-Side Comparison', path: '/compare', desc: 'Directly compare two contracts clause-by-clause' },
          ]
        }
      ]
    }
      ...
      >
        ...
        >
          ...
          <Link to="/" className="navbar__logo" onClick={closeMobile} onMouseEnter={() => setActiveMenu(null)}>
            ...
            <span className="navbar__logo-text">ClauseGuard AI</span>
          </Link>
